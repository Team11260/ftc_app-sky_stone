...
class RecognitionImpl implements Recognition {
  ...
  RecognitionImpl(RecognitionImpl recognition, RectF location) {
    this(recognition.cameraInformation, recognition.label, recognition.confidence, location);
  }

  RecognitionImpl(CameraInformation cameraInformation,
                  String label, float confidence, RectF location) {
