...
public class AutonPursuitPaths {
    ...
    public static double RED_FOUNDATION_Y_2ND = -31.5;
    ...
    public static double BLUE_RUNWAY_Y_2 = -18;

    public static double BLUE_FOUNDATION_Y = -26.5;
    public static double BLUE_FOUNDATION_Y_2ND = -32.5;
    ...
    public static double BLUE_BLOCK_LOCATION_Y = -24.5 + FIELD_OFFSET;
    //count from wall
    ...
    static {
        ...
        RedPurePursuitLeft.addSegment(new PurePursuitSegment("drive to third sky stone",
                new PursuitPath(
                        ...
                        new Point(RED_BLOCK6_X, RED_BLOCK_LOCATION_Y)), PERIOD));
        RedPurePursuitLeft.addSegment(new PurePursuitSegment("last trip to foundation",
                new PursuitPath(
                        ...
                        new Point(RED_FOUNDATION_MIDDLE_NEAR_X, RED_FOUNDATION_Y_2ND)), PERIOD));
    ...
    static {
        ...
        RedPurePursuitCenter.addSegment(new PurePursuitSegment("drive to second sky stone",
                new PursuitPath(
                        ...
                        new Point(RED_BLOCK2_X, RED_BLOCK_LOCATION_Y + OFF_SET)), PERIOD));
...
//                new PursuitPath(new Point(RED_BLOCK4_X, RED_BLOCK_LOCATION_Y), new Point(RED_BLOCK4_X, RED_RUNWAY_Y_2), new Point(RED_FOUNDATION_MIDDLE_NEAR_X, RED_RUNWAY_Y_2), new Point(RED_FOUNDATION_MIDDLE_NEAR_X, RED_FOUNDATION_Y_2ND)), 100));
    ...
    static {
        ...
        RedPurePursuitRight.addSegment(new PurePursuitSegment("first trip to foundation",
                new PursuitPath(
                        new Point(RED_BLOCK6_X, RED_BLOCK_LOCATION_Y),
                        new Point(RED_BLOCK6_X + 10, RED_RUNWAY_Y),
                        new Point(RED_FOUNDATION_MIDDLE_X, RED_RUNWAY_Y),
                        new Point(RED_FOUNDATION_MIDDLE_X, RED_FOUNDATION_Y)), PERIOD));
        RedPurePursuitRight.addSegment(new PurePursuitSegment("drive to second sky stone",
                new PursuitPath(
                        ...
                        new Point(RED_BLOCK3_X, RED_BLOCK_LOCATION_Y + OFF_SET))
                        .setMaxDeceleration(0.01), PERIOD));
        RedPurePursuitRight.addSegment(new PurePursuitSegment("second trip to foundation",
                new PursuitPath(
                        new Point(RED_BLOCK3_X, RED_BLOCK_LOCATION_Y),
    ...
    static {
        RedDragFoundation.addSegment(new PurePursuitSegment("Pull the foundation", new PursuitPath(
                ...
                new Point(RED_FOUNDATION_MIDDLE_NEAR_X + 23, RED_FOUNDATION_Y_2ND + 15))
                .setMinSpeed(0.6)
                .setPositionError(10.0)
                .setHeadingError(2.0), PERIOD, -65));
        RedDragFoundation.addSegment(new PurePursuitSegment("park the foundation", new PursuitPath(
                new Point(RED_FOUNDATION_MIDDLE_NEAR_X + 27, RED_FOUNDATION_Y_2ND + 16),
                new Point(RED_FOUNDATION_MIDDLE_NEAR_X + 20, RED_FOUNDATION_Y_2ND + 17))
                .setMinSpeed(0.5)
                .setPositionError(10.0)
                .setHeadingError(20.0), 0, -90));
        RedDragFoundation.addSegment(new PurePursuitSegment("park the robot", new PursuitPath(
                new Point(RED_FOUNDATION_MIDDLE_NEAR_X + 20, RED_FOUNDATION_Y_2ND + 17),
                new Point(RED_FOUNDATION_MIDDLE_NEAR_X + 26, RED_FOUNDATION_Y_2ND + 5),
                new Point(RED_FOUNDATION_MIDDLE_NEAR_X + 52, RED_FOUNDATION_Y_2ND + 2))
                .setMinSpeed(0.3)
                .setPositionError(8.0)
                .setHeadingError(10.0)
                .setTurnSpeed(0.8), 0, -90));
    }
...
//                .setPositionError(4.0), PERIOD, -90));
    ...
    static {
        RedDragFoundationParking2.addSegment(new PurePursuitSegment("drive down the wall", new PursuitPath(new Point(0, 0), new Point(-22, 0)), 0));
        RedDragFoundationParking2.addSegment(new PurePursuitSegment("drive up to the foundation", new PursuitPath(new Point(-22, 0), new Point(-22, RED_FOUNDATION_Y_2ND)), 0));
        RedDragFoundationParking2.addSegment(new PurePursuitSegment("Pull the foundation", new PursuitPath(new Point(-22, RED_FOUNDATION_Y_2ND), new Point(-3, -10)).setMinSpeed(0.6).setPositionError(5.0).setTurnSpeed(0.6), 1000, -35));
        RedDragFoundationParking2.addSegment(new PurePursuitSegment("park the foundation", new PursuitPath(new Point(-3, -10), new Point(2, -4)).setMinSpeed(0.5).setPositionError(8.0).setTurnSpeed(0.7), 0, -90));
        RedDragFoundationParking2.addSegment(new PurePursuitSegment("park the robot", new PursuitPath(new Point(2, -4), new Point(1, -3), new Point(55 - 12, -1)).setMinSpeed(0.3).setPositionError(4.0), 0, -90));
    }
    ...
    static {
        BluePurePursuitLeft.addSegment(new PurePursuitSegment("drive to first sky stone",
                new PursuitPath(
                        new Point(0, 0),
                        new Point(BLUE_BLOCK6_X, BLUE_BLOCK_LOCATION_Y))
                        .setMaxAcceleration(0.01), PERIOD));
        BluePurePursuitLeft.addSegment(new PurePursuitSegment("first trip to foundation",
                new PursuitPath(
                        ...
                        new Point(BLUE_FOUNDATION_MIDDLE_X, BLUE_FOUNDATION_Y)), PERIOD));
        BluePurePursuitLeft.addSegment(new PurePursuitSegment("drive to second sky stone",
                new PursuitPath(
                        ...
                        new Point(BLUE_BLOCK3_X, BLUE_BLOCK_LOCATION_Y)), PERIOD));
        BluePurePursuitLeft.addSegment(new PurePursuitSegment("second trip to foundation",
                new PursuitPath(
                        new Point(BLUE_BLOCK3_X, BLUE_BLOCK_LOCATION_Y),
                        new Point(BLUE_BLOCK3_X, BLUE_RUNWAY_Y_2),
                        new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X, BLUE_RUNWAY_Y_2),
                        new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X, BLUE_FOUNDATION_Y - 2)), PERIOD));
        BluePurePursuitLeft.addSegment(new PurePursuitSegment("drive to third sky stone",
                new PursuitPath(
                        new Point(BLUE_FOUNDATION_MIDDLE_X, BLUE_FOUNDATION_Y),
                        new Point(BLUE_FOUNDATION_MIDDLE_X, BLUE_RUNWAY_Y),
                        new Point(BLUE_BLOCK5_X, BLUE_RUNWAY_Y + OFF_SET),
                        new Point(BLUE_BLOCK5_X, BLUE_BLOCK_LOCATION_Y)), PERIOD));
        BluePurePursuitLeft.addSegment(new PurePursuitSegment("last trip to foundation",
                new PursuitPath(
                        ...
                        new Point(BLUE_BLOCK5_X, BLUE_RUNWAY_Y_2),
                        new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X, BLUE_RUNWAY_Y_2),
                        new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X, BLUE_FOUNDATION_Y_2ND)), PERIOD));
    }
    ...
    static {
        ...
        BluePurePursuitCenter.addSegment(new PurePursuitSegment("drive to second sky stone",
                new PursuitPath(
                        ...
                        new Point(BLUE_BLOCK2_X, BLUE_BLOCK_LOCATION_Y)), PERIOD));
        BluePurePursuitCenter.addSegment(new PurePursuitSegment("second trip to foundation",
                new PursuitPath(
                        new Point(BLUE_BLOCK2_X, BLUE_BLOCK_LOCATION_Y),
        ...
        BluePurePursuitCenter.addSegment(new PurePursuitSegment("drive to third sky stone",
                new PursuitPath(
                        new Point(BLUE_FOUNDATION_MIDDLE_X, BLUE_FOUNDATION_Y),
                        new Point(BLUE_FOUNDATION_MIDDLE_X, BLUE_RUNWAY_Y),
                        new Point(BLUE_BLOCK6_X, BLUE_RUNWAY_Y + OFF_SET),
                        new Point(BLUE_BLOCK6_X, BLUE_BLOCK_LOCATION_Y)), PERIOD));
    ...
    static {
        BluePurePursuitRight.addSegment(new PurePursuitSegment("drive to first sky stone",
                new PursuitPath(
                        new Point(0, 0), new Point(BLUE_BLOCK4_X, BLUE_BLOCK_LOCATION_Y))
                        .setMaxAcceleration(0.01), PERIOD));
        ...
        BluePurePursuitRight.addSegment(new PurePursuitSegment("drive to second sky stone",
                new PursuitPath(
                        ...
                        new Point(BLUE_BLOCK1_X, BLUE_BLOCK_LOCATION_Y)), PERIOD));
        BluePurePursuitRight.addSegment(new PurePursuitSegment("second trip to foundation",
                new PursuitPath(
                        new Point(BLUE_BLOCK1_X, BLUE_BLOCK_LOCATION_Y),
    ...
    static {
        BlueDragFoundation.addSegment(new PurePursuitSegment("drive to the wall", new PursuitPath(
                new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X, BLUE_FOUNDATION_Y_2ND),
                new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X - 6, BLUE_FOUNDATION_Y_2ND + 9))
                .setMinSpeed(0.8)
                .setPositionError(10.0), PERIOD));
...
//        BlueDragFoundation.addSegment(new PurePursuitSegment("park the robot", new PursuitPath(new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X - 17, BLUE_FOUNDATION_Y_2ND + 4), new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X - 26, BLUE_FOUNDATION_Y_2ND + 1), new Point(BLUE_FOUNDATION_MIDDLE_NEAR_X - 48, BLUE_FOUNDATION_Y_2ND + -2)).setMinSpeed(0.3).setPositionError(4.0), 0, 90));
    ...
    public final static Path BlueRobotPark = new Path("Blue Robot Park");

    static {

        BlueRobotPark.addSegment(new PurePursuitSegment("park the robot", new PursuitPath(
                new Point(BLUE_FOUNDATION_MIDDLE_X - 10, -45),
                new Point(43, -44))
                .setMinSpeed(0.3)
                .setHeadingError(10.0)
                .setPositionError(3.0), PERIOD, 90));
