...
public class ComponentMover extends MouseAdapter {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if(e.getComponent() instanceof UI.SliderPanel && (((UI.SliderPanel) e.getComponent()).getSlider().getHeight()/2) - 10 < e.getPoint().y && (((UI.SliderPanel) e.getComponent()).getSlider().getHeight()/2) + 10 > e.getPoint().y) return;
